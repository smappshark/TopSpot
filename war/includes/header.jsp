                        ...
                        <ul class="dropdown-menu chat media-list pull-right">
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="topspot_images/people/100/15.jpg"
                                    alt="50x50" width="50" />
                                </a>
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="topspot_images/people/100/16.jpg"
                                    alt="50x50" width="50" />
                                </a>
                                <div class="media-body">
                            ...
                            <li class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumb" src="topspot_images/people/100/17.jpg"
                                    alt="50x50" width="50" />
                                </a>
                                <div class="media-body">
