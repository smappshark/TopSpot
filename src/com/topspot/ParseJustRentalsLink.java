...
public class ParseJustRentalsLink {
	public static Connection conn = null;
	public static int count=0;
	 public static void main(String[] args) throws ClientProtocolException, IOException {
		 ParseJustRentalsLink objParseJustRentalsLink = new ParseJustRentalsLink();
		/* conn=UtilityClass.dbConnection();
		 ...
		 objParseJustRentalsLink.parseResponseForNoPages(siteUrlRentals1);
		 System.out.println("one completed--->");
		 objParseJustRentalsLink.parseResponseForNoPages(siteUrlRentals2);
		 System.out.println("Two completed--->");
		 objParseJustRentalsLink.parseResponseForNoPages(siteUrlRentals3);
	 ...
	 public ParseJustRentalsLink()
	 {
	//	 conn=UtilityClass.dbConnection();
		 conn=UtilityClass.conn;
		 UtilityClass.purgeDomains("justRentals_data");
			count= UtilityClass.recordCount("justRentals_data");
		...
		parseResponseForNoPages(siteUrlRentals1);
		 System.out.println("one completed--->");
		 parseResponseForNoPages(siteUrlRentals2);
		 System.out.println("Two completed--->");
		 parseResponseForNoPages(siteUrlRentals3);
		 System.out.println("Three completed--->");
	 }
...
//		System.out.println("businessType--->"+businessType);
	...
	//		  System.out.println("Doc123--->");
			  ...
			  //System.out.println("strSize number of pages --- >"+strSize);
	//		  System.out.println("strSizeDocABC--->"+strSize);
			  String[] Nopages=strSize.split("of");
			  //System.out.println("Nopages[1] --- >"+Nopages[1]);
			  String[] Nopages1=Nopages[1].split("Prev");
			  //System.out.println("Nopages1[0] --- >"+Nopages1[0]);
			  String str = Nopages1[0].replaceAll("\\D+","");
	...
	// Reference Start
		...
		//	  System.out.println("objElementsRef.size() -->"+objElementsRef.size());
			  ListIterator<Element> obListRef=objElementsRef.listIterator();
			  while(obListRef.hasNext())
			  {
				  Element objElement1= obListRef.next();
			//	  System.out.println("objElement1.size -->"+objElement1.getAllElements().size());
			...
			//	  System.out.println("objAttrs.size() -->"+objAttrs.size());
			//	  System.out.println("objAttrs -->"+objAttrs);
		...
		//			  System.out.println("objAttr.getKey -->"+objAttr.getKey());
		 ...
		 try
		  {
			 System.out.println("conn123----->"+conn.toString());
              ...
              //       "INSERT INTO justRentals_data (Sno,domain_name, Bedrooms, " + 
